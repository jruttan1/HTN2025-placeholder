            ...
            <div className="flex items-center space-x-6">
              ...
              <Avatar className="h-12 w-12">
                <AvatarFallback className="font-semibold bg-white text-blue-700">
                  {userData ? userData.name.split(' ').map(n => n[0]).join('').toUpperCase() : 'NA'}
                </AvatarFallback>
              </Avatar>
            </div>
          </div>
          ...
          <Card className="mb-8 shadow-sm border-green-200 bg-green-50 relative">
            <CardContent className="p-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-green-800">Welcome to Optimate!</h3>
                  <p className="text-green-700">Your account has been set up successfully.</p>
                </div>
              </div>
            </CardContent>
          </Card>
